...
window.ysdk_init = function() {
    ...
    YaGames.init().then(function(ysdk) {
        ...
        var lang = (ysdk.environment && ysdk.environment.i18n && ysdk.environment.i18n.lang) || "en";
        _push({ type: "init_ok", lang: lang });
    }).catch(function(err) {
...
window.ysdk_get_player = function() {
    ...
    window.__ysdk.getPlayer({ scopes: false, signed: true }).then(function(player) {
        _push({
            type: "player_info",
            name: player.getName() || "",
